...
function Monthlyreport() {
 ...
 const clickPrintIcon = (row) => {
  ...
  // export to excel (reuse your logic)
  ...
  // custom toolbar for DataGrid (quick filter + export button)
  ...
  const columns = [
    { field: "id", headerName: "ID", width: 70 },
    {
      ...
      headerName: "Doc",
      width: 90,
      valueGetter: (params) => params.row.doc,
    },
    {
      field: "date",
      headerName: "Date",
  ...
  // selected rows state for export
